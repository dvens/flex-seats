	...
	<ul class="calendar__dates">
		<?php forEach($dates as $key => $date) {  ?>
			...
			<?php if($date['status'] === 'office') { ?>
				<li <?php echo ($date['disabled'] ? 'disabled' : ''); ?>  class="calendar__date calendar__date--office <?php echo (matchDay($date['date'], $fullDate) ? 'is--active' : ''); ?>">
	...
	<section class="calendar__content grid__container">
		...
		<div class="grid__column grid__column--half">
			...
			<div class="calendar__holder">
				<p class="calendar__amount"><?php echo $amountDesks; ?></p>
